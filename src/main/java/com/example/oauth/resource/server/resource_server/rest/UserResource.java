...
import com.example.oauth.resource.server.resource_server.rest.errors.BadRequestAlertException;
import com.example.oauth.resource.server.resource_server.rest.errors.EmailAlreadyUsedException;
import com.example.oauth.resource.server.resource_server.rest.errors.LoginAlreadyUsedException;
import com.example.oauth.resource.server.resource_server.rest.util.HeaderUtil;
...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        Optional<User> existingUser = userRepository.findOneByLogin(userDTO.getEmail());
